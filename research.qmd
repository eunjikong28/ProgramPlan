...
description <- c("EDUC 650: Single case study of the impact of observation vs immediate coaching in parent-mediated intervention", "PREV 640: Meta-Analysis on Social Communication Intervention for Autistic Individuals to Promote Initiation of Social Communication")
autism <- c("X"," ") 
optimization <- c("X","X") 
eds <- c(" "," ") 
term <- c("Winter 2023","Spring 2023") 
evaluation <- c("Dr. Machalicek","Dr. Tanner-Smith") 
...
description <- c("A Systematic Review of Data Visualization Tools in Clinical Practice for Evidence-Based Decision Making in Autism Intervention")
autism <- c("X") 
optimization <- c(" ") 
eds <- c("X") 
term <- c("Spring 2023") 
evaluation <- c("Dr. Shire, Dr. Seely, Dr. Zopluoglu") 
